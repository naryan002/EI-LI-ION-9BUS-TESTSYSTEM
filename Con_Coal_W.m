...
mpc.branch(:,6) = 200*ones(size(mpc.branch,1),1);%#of rows,adding one to that and multiplying by 1000 then changing the rateA column to that value
mpc.branch(1,6) = 1000;
mpc.branch(4,6) = 1000;
mpc.branch(7,6) = 1000;
...
xlswrite('impacts_Xu.xlsx',label,1,'A26')
xlswrite('impacts_Xu.xlsx',impacts,1,'B26')
