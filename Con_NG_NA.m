...
mpc.branch(:,6) = 170*ones(size(mpc.branch,1),1);
mpc.branch(1,6) = 1000;
mpc.branch(4,6) = 1000;
mpc.branch(7,6) = 1000;
...
xlswrite('impacts_Xu.xlsx',label,1,'A23')
xlswrite('impacts_Xu.xlsx',impacts,1,'B23')
...
figure
plot(tvec,coal_vec,'-o',tvec,gas_vec,'-o')
xlabel('Hours')
ylabel('Fuel (mmBtu)')
legend('Coal','Gas')
