...
%     ylim([0,30])
    ...
    F_coal_delta = sum(Fuel_coal) - sum(Fuel_coal_noES); 
    F_gas_delta = sum(Fuel_gas) - sum(Fuel_gas_noES); 
...
xlswrite('impacts_Xu.xlsx',label,1,'A9')
xlswrite('impacts_Xu.xlsx',impacts,1,'B9')
