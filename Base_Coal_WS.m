...
xlswrite('impacts_Xu.xlsx',label,1,'A8')
xlswrite('impacts_Xu.xlsx',impacts,1,'B8')

%%
figure
plot(tvec,co2_vec,'-o','MarkerSize',4) 
xlabel('Hours')
ylabel('CO_2 (kg)')
saveas(gca, fullfile(fname,'CO2'),'fig');

figure
plot(tvec,coal_vec,'-o',tvec,gas_vec,'-o','MarkerSize',4) 
xlabel('Hours')
ylabel('Fuel (mmBtu)')
legend('Coal','Gas')
