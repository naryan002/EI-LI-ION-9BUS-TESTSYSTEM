...
life=15120; %this will need to be changed with degradation
Endlife_cap = 0.5;
Starting_cap = 1;
...
c_off = [5.61*mpc.gen(1,9);5.61*mpc.gen(2,9);3.99*mpc.gen(3,9);3.99*mpc.gen(4,9)];
c_rES = 0.1;
...
while Current_cap > Endlife_cap
    ...
    if (Current_t) == 0
        ...
        Current_cap = func_BatteryDegrade(Current_t)
    end
    tvec = [tvec;Current_t];
...
xlswrite('impacts.xlsx',label,1,'A36')
xlswrite('impacts.xlsx',impacts,1,'B36')
