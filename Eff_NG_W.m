...
eff_loss=0;%(eff-EOL_eff)/life*24*30; %13680 is the life of the battery
...
while Current_cap > Endlife_cap
    ...
    if (Current_t) == 0
        ...
        Current_cap = Starting_cap-(1-eff_BatteryDegrade_Xu(Current_t))
    end
    tvec = [tvec;Current_t];
...
xlswrite('impacts_Xu.xlsx',label,1,'A45')
xlswrite('impacts_Xu.xlsx',impacts,1,'B45')
